...
@section('content')
    ...
    <div class="row mx-0 row-benefits">
        ...
        <div class="col-md-6 size-row">
            <p class="card-text"><span class="text-red"><b>Atención personalizada</b></span> por<br> nuestro equipo
                profesional<br> de asesores comerciales</p>
        </div>
    </div>
    ...
    <div class="row mx-0 row-benefits">
        <div class="col-md-6 size-row">
            <div>
                <p class="card-text">Préstamos a asociados con <br> edad<span class="text-red"><b> hasta 84 años</b></span>
                </p>
            </div>
        </div>
        <div class="col-md-6 size-row">
    ...
    <div class="row mx-0 row-benefits">
        ...
        <div class="col-md-6 size-row">
            <p class="card-text"><span class="text-red"><b>Cuota fija en pesos durante <br>todo el plazo </span></b> del
                Crédito con <br>cómodas tasas de financiación</p>
        </div>
    </div>
    ...
    <div class="row mx-0 row-benefits">
        ...
        <div class="col-md-6 size-row">
            <p class="card-text">Monto desde <span class="text-red"><b> $500.000 </b></span> hasta <br><span
                    class="text-red"><b> $80.000.000 </b></p>
        </div>
    </div>

    <div class="row mx-0 final-div">
        <div class="col-md-6 size-row">
            <p class="card-text">El monto a otorgar se define <br> de acuerdo con la <span class="text-red"><b> Pagaduría,
                        <br> Capacidad de pago, la edad y <br> Perfil de cada asociado </b></span></p>
        </div>
        <div class="col-md-6 size-row">
